...
public class MainActivity extends AppCompatActivity
    ...
    private void retrieveData(){
        ...
        while (c.moveToNext()) {
            ...
            ListViewData listViewData = new ListViewData(id, name, date, time);
    ...
    private void addItem(String name, String date, String time) {
        dbHelper = new DBHelper(this);
        try{
            dbHelper.insertData(name, date, time);
    ...
    private void updateItem(int id, String name, String date, String time){
        dbHelper = new DBHelper(this);
        boolean updated = dbHelper.updateData(id, name, date, time);
        if (updated) {
